...
namespace UI
{
	...
	static void DRAW_TEXT(char* p0, float p1, float p2) { invoke<Void>(0xD79334A4BB99BAD1, p0, p1, p2); }
	...
	template<typename... Args> static const char* _CREATE_VAR_STRING(int p0, const char* p1, Args... args) { return invoke<const char*>(0xFA925AC00EB830B9, p0, p1, args...); } // 0xFA925AC00EB830B9 b1207
	static void _DRAW_TEXT(const char* text, float xPos, float yPos) { invoke<Void>(0xD79334A4BB99BAD1, text, xPos, yPos); } // 0xD79334A4BB99BAD1 b1207
	static void _SET_TEXT_COLOR(int r, int g, int b, int a) { invoke<Void>(0x50A41AD966910F03, r, g, b, a); } // 0x50A41AD966910F03 b1207


	static void SET_TEXT_COLOR_RGBA(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x50A41AD966910F03, p0, p1, p2, p3); }
...
namespace GRAPHICS
{
	...
	static void DRAW_SPRITE(char* textureDict, char* textureName, float screenX, float screenY, float width, float height, float heading, int red, int green, int blue, int alpha, BOOL p11) { invoke<Void>(0xC9884ECADE94CB34, textureDict, textureName, screenX, screenY, width, height, heading, red, green, blue, alpha, p11); }
...
namespace TEXTURE
{
	...
	static void REQUEST_STREAMED_TEXTURE_DICT(char* textureDict, BOOL unused) { invoke<Void>(0xC1BA29DF5631B0F8, textureDict, unused); }
	static BOOL HAS_STREAMED_TEXTURE_DICT_LOADED(char* textureDict) { return invoke<BOOL>(0x54D6900929CCF162, textureDict); }
	static void SET_STREAMED_TEXTURE_DICT_AS_NO_LONGER_NEEDED(char* textureDict) { invoke<Void>(0x4ACA10A91F66F1E2, textureDict); }
}
